...
INSERT INTO "new_NewsItem" ("category", "content", "createdAt", "htmlContent", "id", "imageUrl", "isPublishedDaily", "isPublishedMain", "isSelected", "isSentSNS", "originalUrl", "publishedAt", "source", "status", "summary", "title", "translatedContent", "translatedSummary", "translatedTitle", "translationStatus", "updatedAt") SELECT "category", "content", "createdAt", "htmlContent", "id", "imageUrl", "isPublishedDaily", "isPublishedMain", "isSelected", "isSentSNS", "originalUrl", "publishedAt", "source", "status", "summary", "title", "translatedContent", "translatedSummary", "translatedTitle", "translationStatus", "updatedAt" FROM "NewsItem";
DROP TABLE "NewsItem";
